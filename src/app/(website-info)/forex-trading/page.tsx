...
const page = () => {
  ...
  return (
   <WebsiteDetails
    title={'Forex Trading'} 
    title1='Trade forex on the platform and enjoy reliable pricing and exceptional execution'
    body={<Body />}
   />
  )
}
